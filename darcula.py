...
palette.update({
    ...
    # source view
    "source": (white, bg),
    "current source": (white, "h24"),
    "breakpoint source": (white, "h88"),
    "current highlighted": (bright_white, "h24"),
    "current keyword": (orange, "h24"),
    "current keyword2": (orange, "h24"),
    "current builtin": (orange, "h24"),
    "current literal": (blue, "h24"),
    "current string": (green, "h24"),
    "current docstring": (green, "h24"),
    "current comment": (gray, "h24"),
    "current function": (yellow, "h24"),
    "current class": (add_setting(yellow, "underline"), "h24"),
    "current argument": (purple, "h24"),
    "current pseudo": (purple, "h24"),
    "current operator": (white, "h24"),
    "current exception": (red, "h24"),
    "current line number": (gray, "h24"),
    "line number": (gray, bg),
